...
// Update: make chat items feel like real buttons (hover/active/focus + small chevron + active highlight)
...
export function Sidebar({
  ...
  return (
    <aside className="w-96 shrink-0 h-full p-6">
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <div className="text-xs text-muted-foreground opacity-70 group-hover:opacity-100 transition">
                      ›
                    </div>
                  </div>
